...
import com.candlekart.user_service.exc.UserAlreadyExistsException;
...
public class UserService {
    ...
    public UserResponse createUser(UserRequest request) {
        ...
        if (userRepository.existsByPhoneNumber(request.getPhoneNumber()))
            throw new UserAlreadyExistsException("Phone Number '" + request.getPhoneNumber() + "' is already taken.");
    ...
    public UserResponse updateUser(UpdateUserRequest request) {
        ...
        //Todo Should not be changed without verification bcoz they are unique
